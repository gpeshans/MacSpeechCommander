package mk.ukim.finki.jmm.commander.pocketsphinx;

import java.util.concurrent.LinkedBlockingQueue;

import mk.ukim.finki.jmm.commander.app.MacSpeechCommanderHome;
...
public class RecognizerTask implements Runnable {
	...
	public RecognizerTask() {
		 ...
		 * called
		 */
		c.setString("-hmm", Environment.getExternalStorageDirectory().getPath()
				+ "/" + MacSpeechCommanderHome.APP_NAME + "/model");
		c.setString("-dict", Environment.getExternalStorageDirectory()
				.getPath()
				+ "/"
				+ MacSpeechCommanderHome.APP_NAME
				+ "/commands.dic");
